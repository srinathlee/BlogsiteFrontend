        ...
        <div className="px-5 py-1 md:px-8 max-w-450px] w-[500px] h-fit shadow-xl rounded-xl bg-white dark:bg-black dark:border">
          ...
          <div className="flex flex-col gap-1 mt-4">
            ...
            <input
              ...
              type="email"
              className=" border border-gray-200 outline-none py-1 md:py-3 text-md rounded-md px-1 dark:bg-black "
          ...
          <div className="flex flex-col gap-1 mt-4">
            ...
            <input
              ...
              onChange={getUserData}
              type="password"
              className="border border-gray-200 dark:bg-black  outline-none  py-1 md:py-3 text-md rounded-md px-1"
          ...
          <div className="flex items-center justify-between mt-4">
            <div className="flex items-center gap-2 ">
              <input
                id="login-checkbox"
                className="h-4 w-4 dark:bg-black "
                type="checkbox"
              />
              <label
          ...
          <button
            onClick={login}
            className="  bg-[#5B0913] rounded-sm md:rounded-xl  text-white px-4 w-[100%] py-1 md:py-3 mt-4 "
          >
            Sign in
          </button>
           <a
          ...
          <p className="text-center mt-4 mb-2  dark:text-white">
            Dont have an account yet?{" "}
            <Link to="/register">
              <span className="text-[#5B0913] font-semibold">Register</span>
            </Link>
          </p>
          <p>Or</p>
          <br></br>
