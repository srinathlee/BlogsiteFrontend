...
const LoginPage = () => {
  return (
    <div className=" dark:bg-black flex px-8 flex-row justify-center items-center h-[90vh] login-bg-container">
      <div className="p-8 max-w-450px] w-[500px] h-fit shadow-xl rounded-xl bg-white dark:bg-black dark:border">
        <div className="flex flex-col items-center gap-2">
        
            <img className="w-36" src={logo} />
          <h1 className="font-semibold text-2xl text-[#5B0913] dark:text-white">Welcome Back</h1>
        ...
        <div className="flex flex-col gap-1 mt-4">
          ...
          <input type="email" className=" border border-gray-200 outline-none py-3 text-md rounded-md px-1 dark:bg-black " placeholder="Enter your email.." />
        </div>
        <div className="flex flex-col gap-1 mt-4">
          <label className="text-lg  dark:text-white">Password</label>
          <input type="password" className="border border-gray-200 dark:bg-black  outline-none py-3 text-md rounded-md px-1" placeholder="Enter your password.." />
        </div>
        ...
        <button className="  bg-[#5B0913] rounded-xl  text-white px-4 w-[100%] py-3 mt-4 ">Sign in</button>
