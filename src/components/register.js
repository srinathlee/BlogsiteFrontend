    ...
    <div className="dark:bg-black  flex px-8 flex-row justify-center items-center py-5 login-bg-container">
      <div className="px-5 md:px-8 py-4 max-w-450px] w-[500px] h-fit shadow-xl rounded-xl bg-white  dark:bg-black dark:border">
        <div className="flex flex-col items-center gap-1 md:gap-2">
          ...
          <h1 className="font-semibold text-xl md:text-2xl text-[#5B0913] dark:text-white">Welcome</h1>
        ...
        <div className="grid grid-cols-2 gap-2 md:gap-3">
          <div className="flex flex-col gap-1 col-span-4 ">
            <label className="text-base md:text-lg dark:text-white">Name</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-1 col-span-4 md:col-span-2">
            <label className="text-base md:text-lg dark:text-white">Number</label>
            <input
              type="text"
              className="border hover:shadow-sm  border-gray-200 outline-none py-1 md:py-3 text-md rounded-md px-1 dark:bg-black"
        ...
        <div className="flex items-center justify-between mt-4">
          <div className="flex items-center gap-2 ">
            ...
            <label htmlFor="login-checkbox" className="md:text-base text-sm  dark:text-white">
              Remember me
            </label>
          </div>
          <p className="md:text-base text-sm dark:text-white">Forgot password ?</p>
        </div>
        <button className="bg-[#5B0913] rounded-sm md:rounded-xl  text-white px-4 w-[100%] py-1 md:py-3 mt-2 md:mt-4 ">
          Sign up
        </button>
